...
\colorlet{beamer@blendedblue}{green!75!black}

% \usecolortheme{albatross}
% \usecolortheme{beaver}
% \usecolortheme{beetle} %grey background, I like it for screen. color at bottom
% \usecolortheme{crane}
% \usecolortheme{dolphin} % as standard but lighter shades
% \usecolortheme{dove} %% Muy minimalista!! sólo blanco!!
% \usecolortheme{fly} %grey background, I like it for screen
% \usecolortheme{lily} %default?
% \usecolortheme{orchid} %default?
% \usecolortheme{rose} %default?
% \usecolortheme{seagull} %default in gray
% \usecolortheme{seahorse} %default lighter colors
% \usecolortheme{whale} %default?
% \usecolortheme{wolverine} de boca juniors
...
\title[Taller CR]{Taller de ChiRunning – 1er módulo} % The short title appears at the bottom of every slide, the full title is only on the title page
...
%------------------------------------------------
\section{Postura} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
